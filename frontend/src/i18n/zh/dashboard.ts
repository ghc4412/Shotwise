...
export default {
  ...
  'flow_field_source_file': '源文件（source_file）',
  ...
  'flow_template_novel_to_manga_desc': '从源文件、剧本和分镜一路生成视频，自动完成配音、字幕、质检和成片导出',

...
export default {
  ...
  'accent_theme': 'Màu chủ đề',
  'accent_aurora': 'Xanh neon',
  'accent_jade': 'Ngọc bích',
  'accent_violet': 'Tím sao',
  'accent_crimson': 'Đỏ thắm',
  'accent_amber': 'Hổ phách',
  'accent_ocean': 'Xanh đại dương',
  'account_menu': 'Menu tài khoản ({{username}})',

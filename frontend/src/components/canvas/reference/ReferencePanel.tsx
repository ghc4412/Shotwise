...
export function ReferencePanel({
  ...
  return (
    <div className="relative flex-shrink-0 border-b border-[var(--color-hairline-soft)] bg-[var(--color-shell-side-a)] px-3 py-2.5">
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        <button
          ...
          className="focus-ring inline-flex items-center gap-1 rounded-full border border-dashed border-[var(--color-hairline-strong)] bg-[var(--color-shell-field)] px-2.5 py-1 text-xs text-[var(--color-text-3)] transition-colors hover:border-[var(--color-accent-soft)] hover:text-[var(--color-text)]"
        >

...
| 操作 | 工具 |
|------|------|
| 重新生成单个 unit | `mcp__shotwise__generate_video_scene({"script": "episode_1.json", "scene_id": "E1U2"})` |
| 重新生成多个 unit | `mcp__shotwise__generate_video_selected({"script": "episode_1.json", "scene_ids": ["E1U2", "E1U3"]})` |

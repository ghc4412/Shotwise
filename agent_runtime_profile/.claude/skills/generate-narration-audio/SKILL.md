...
| 操作 | 工具 |
|------|------|
| 全集补齐（默认，所有缺音频的段） | `mcp__shotwise__generate_narration_audio({"script": "episode_1.json"})` |
| 指定批量范围 | `mcp__shotwise__generate_narration_audio({"script": "episode_1.json", "segment_ids": ["E1S01", "E1S02"]})` |
| 单段重生 | `mcp__shotwise__generate_narration_audio({"script": "episode_1.json", "segment_ids": ["E1S05"]})` |
...
> `mcp__shotwise__patch_project({"settings": {"narration_voice": "X", "narration_speed": 1.2}})`

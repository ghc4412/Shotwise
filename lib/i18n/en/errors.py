MESSAGES = {
    ...
    "generation_asset_preflight_failed": "Generation preflight failed. Unregistered assets: {unregistered}; missing asset images: {missing_images}; missing character variants: {missing_variants}",
    ...
    "character_variant_not_found": "Character variant '{name}' does not exist",
    "character_variant_slug_exists": "Character variant slug '{slug}' already exists",
    "character_variant_invalid_slug": "Character variant slug is invalid",
    "character_variant_invalid_image_path": "Character variant image path is invalid",
    "character_variant_invalid_status": "Character variant status is invalid",
    "character_avatar_file_empty": "The avatar file cannot be empty",
    "character_avatar_too_large": "The avatar file cannot exceed {max_mb} MB",
    "character_avatar_invalid_file": "The avatar file is not a valid image",
    "character_avatar_pixels_too_large": "The avatar image has too many pixels; keep it under {max_megapixels} megapixels",
    "character_task_submitted": "Character design generation task for '{name}' submitted",
    "character_relations_revision_conflict": "Character relationships changed elsewhere. Refresh and try again.",
    "character_relations_analysis_invalid": "The AI returned invalid character relationships: {message}",
    "character_relations_analysis_failed": "AI relationship analysis failed. Try again later or switch text models.",
    ...
    "script_review_quarantine_schema_unsupported": (
        "This quarantined draft uses unsupported schema version {version}; upgrade the application before continuing"
    ),
    ...
    "episode_display_number_invalid": "Display number must be between 1 and {max}",
    ...
    "video_resolution_not_supported": "Model {model} does not support {resolution} resolution; use {supported}",
    ...
    "video_kling_model_endpoint_unsupported": "The current Kling API endpoint does not support multi-subject reference-to-video for model {model} ({endpoint}); use a base URL or model that supports it, or remove the reference images and use first-frame or text-to-video",
    ...
    "assistant_images_too_large": "The total chat attachment size exceeds the limit; remove or compress images and try again",
    "assistant_image_pixels_too_large": "The chat attachment resolution is too high; resize it and try again",
    "assistant_image_type_unsupported": "This chat attachment type is not supported; upload an image file",
    "asset_generation_reused": "Asset “{name}” already has a usable design image; duplicate generation was skipped",
    ...
    "memory_scope_invalid": "Invalid memory scope; expected user or project",
    "memory_project_required": "A project is required for project-scoped memory",
    "memory_project_invalid": "The memory project identifier is invalid",
    "memory_category_invalid": "Invalid memory category",
    "memory_source_invalid": "Invalid memory source",
    "memory_content_invalid": "Invalid memory content",
    "memory_content_empty": "Memory content cannot be empty",
    "memory_content_too_long": "Memory content is too long; the maximum is {max_length} characters",
    "memory_sensitive_content": "Memory content appears to contain a key, password, or sensitive path and cannot be saved",
    "memory_prompt_injection": "Memory content appears to contain a prompt injection and cannot be saved",
    "memory_duplicate": "The same memory already exists",
    "memory_update_empty": "Provide at least one field to update",
    "memory_not_found": "Memory was not found",
    "memory_candidate_not_found": "Memory candidate was not found",

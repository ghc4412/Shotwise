...
PRESET_PROVIDERS: dict[str, PresetProvider] = {
    ...
    "alibaba-coding-plan-openai": PresetProvider(
        id="alibaba-coding-plan-openai",
        display_name="Alibaba Cloud Coding Plan",
        icon_key="Qwen",
        messages_url="https://coding.dashscope.aliyuncs.com/v1",
        discovery_url=None,
        default_model="",
        suggested_models=("qwen3.6-plus", "qwen3-coder-plus", "kimi-k2.5", "glm-5", "MiniMax-M2.5"),
        docs_url="https://help.aliyun.com/zh/model-studio/coding-plan-faq",
        api_key_url="https://bailian.console.aliyun.com/",
        notes_i18n_key="preset_notes_alibaba_coding_plan",
        api_key_pattern=r"^sk-sp-[A-Za-z0-9_-]+$",
    ...
    "minimax-cn-openai": PresetProvider(
        id="minimax-cn-openai",
        display_name="MiniMax (中国)",
        icon_key="Minimax",
        messages_url="https://api.minimaxi.com/v1",
        discovery_url="https://api.minimaxi.com/v1",
        default_model="MiniMax-M3",
        suggested_models=("MiniMax-M3", "MiniMax-M2.7", "MiniMax-M2.5"),
        docs_url=None,
        api_key_url="https://platform.minimaxi.com/subscribe/coding-plan",
        notes_i18n_key=None,
        api_key_pattern=None,
    ...
    "minimax-intl-openai": PresetProvider(
        id="minimax-intl-openai",
        display_name="MiniMax (Global)",
        icon_key="Minimax",
        messages_url="https://api.minimax.io/v1",
        discovery_url="https://api.minimax.io/v1",
        default_model="MiniMax-M3",
        suggested_models=("MiniMax-M3", "MiniMax-M2.7", "MiniMax-M2.5"),
        docs_url=None,
        api_key_url="https://platform.minimax.io/subscribe/coding-plan",
    ...
    "ark-coding-plan-openai": PresetProvider(
        id="ark-coding-plan-openai",
        display_name="Volcengine Ark Coding Plan",
        icon_key="Volcengine",
        messages_url="https://ark.cn-beijing.volces.com/api/coding/v3",
        discovery_url=None,
        default_model="",
        suggested_models=(
            "doubao-seed-2.0-code",
    ...
    "ark-agent-plan-openai": PresetProvider(
    ...
    "tencent-tokenhub-coding-openai": PresetProvider(
        id="tencent-tokenhub-coding-openai",
        display_name="Tencent Cloud TokenHub Coding Plan",
        icon_key="TencentCloud",
        messages_url="https://api.lkeap.cloud.tencent.com/coding/v3",
        discovery_url=None,
        default_model="",
        suggested_models=(),
        docs_url="https://cloud.tencent.com/document/product/1823/130092",
    ...
    "openrouter-openai": PresetProvider(
        id="openrouter-openai",
        display_name="OpenRouter",
        icon_key="OpenRouter",
        messages_url="https://openrouter.ai/api/v1",
        discovery_url="https://openrouter.ai/api/v1",
        default_model="anthropic/claude-sonnet-4",
        suggested_models=(),
    ...
    "siliconflow-openai": PresetProvider(
        id="siliconflow-openai",
        display_name="SiliconFlow",
        icon_key="SiliconCloud",
        messages_url="https://api.siliconflow.cn/v1",
        discovery_url="https://api.siliconflow.cn/v1",
        default_model="Pro/zai-org/GLM-4.7",
        suggested_models=(),
    ...
    "agnes-openai": PresetProvider(
        ...
        suggested_models=("agnes-2.5-flash",),
        docs_url=None,

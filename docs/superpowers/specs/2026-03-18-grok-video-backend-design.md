...
> Issue: [#100](https://github.com/ghc4412/Shotwise/issues/100) — grok-imagine-video 接入
> 父任务: [#98](https://github.com/ghc4412/Shotwise/issues/98) — 多供应商视频生成
> 前置依赖: [#99](https://github.com/ghc4412/Shotwise/issues/99) — 提取通用视频生成服务层（已完成）

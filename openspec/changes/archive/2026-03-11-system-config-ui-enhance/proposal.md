...
- **顶栏多 Tab 结构**：将所有配置拆分为四个顶栏 Tab，与现有"API Keys"并列：**Shotwise 智能体配置**、**AI 生图/生视频配置**、**高级配置**、**API Keys**
...
- **必填配置缺失警告**：当 Shotwise 智能体 API Key（Anthropic）或 AI 生成后端（AI Studio / Vertex AI 二选一）未配置时，系统无法正常运行；需在项目大厅的设置入口和设置页本身给予明显提示
